...
class plot_triage_real:
	def __init__(self,list_of_K,list_of_std, list_of_lamb,list_of_option,list_of_test_option):
	...
	def plot_err_vs_K(self,image_file,plot_obj):
		...
		plt.plot(plot_obj['greedy']['train'],label='GREEDY Train',linewidth=8,linestyle='--',marker='o', markersize=10,color='red')
		plt.plot(plot_obj['greedy']['test'],label='GREEDY Test',linewidth=8,linestyle='--',marker='o', markersize=10,color='green')
		# plt.plot(plot_obj['diff_submod']['train'],label='DS Train',linewidth=8,linestyle='-',marker='o', markersize=10,color='blue')
		# plt.plot(plot_obj['diff_submod']['test'],label='DS Test',linewidth=8,linestyle='-',marker='o', markersize=10,color='black')
		plt.grid()
		plt.legend()
		plt.xlabel('K')
	...
	def compute_result(self,res_file,data_file,option):
	...
	def split_res_over_K(self,data_file,res_file,unified_K):
		res=load_data(res_file)
		for std in self.list_of_std:
			if str(std) not in res:
				res[str(std)]={}
	...
	def get_res_for_subset(self,data_file,res_dict,lamb,K):
		...
		# print curr_n
		# print 'from '
		# print res_dict['subset'].shape
		subset_tr = res_dict['subset'][:curr_n]
		# print '----------------'
		# print subset_tr.shape
		# print '----------------'
...
def main():
	...
	list_of_option=['greedy'] #'diff_submod_greedy'# 'greedy'#'diff_submod_greedy'#'greedy'#
	list_of_test_option = ['nearest','ranking']
	...
	unified_K = 0.99
	obj.split_res_over_K(data_file,res_file,unified_K)
	option='greedy'
	obj.compute_result(res_file,data_file,option)
